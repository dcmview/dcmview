		...
		with (
			mock.patch.dict(
				os.environ,
				{
					...
					"DCMVIEW_CORPUS_ACTIONS_ZIP_SHA256": "1" * 64,
					"DCMVIEW_CORPUS_ACTIONS_ZIP_SIZE_BYTES": "101",
					"DCMVIEW_CORPUS_NESTED_ARCHIVE_SHA256": "2" * 64,
					"DCMVIEW_CORPUS_NESTED_ARCHIVE_SIZE_BYTES": "102",
					"DCMVIEW_CORPUS_RELEASE_MANIFEST_SHA256": "3" * 64,
					"DCMVIEW_CORPUS_RELEASE_MANIFEST_SIZE_BYTES": "103",
					"DCMVIEW_CORPUS_INSTALLED_BINARY_SHA256": "b" * 64,
					"DCMVIEW_CORPUS_INSTALLED_BINARY_SIZE_BYTES": "123",
